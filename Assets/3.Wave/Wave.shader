...
Shader "Portfolio/Wave"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _Color("Main Color", Color) = (1, 1, 1, 1)
        _TessellationEdgeLength("Tessellation Edge", Range(0.01, 1)) = 1
        ...
        _WaveDir1("Wave Direction 1", Vector) = (1,1,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //    f.insideTess = _TessellationEdge;
            //    return f;
            //}
            ...
            d2f doma(tessFactor i, OutputPatch <pdata, 3> patch, float3 bary:SV_DOMAINLOCATION)
            {
                ...
                o.normal = UnityObjectToWorldNormal(normalize(CalculateNormal(p1.y - o.objectPos.y, p2.y - o.objectPos.y, scale)));
